...
void USTUHealthComponent::PlayCameraShake()
{
    ...
    // const auto Controller1 = Player->GetController<APlayerController>();
    // if (!Controller1 || Controller1->PlayerCameraManager) return;

    Controller->PlayerCameraManager->StartCameraShake(CameraShake);
    /*  Controller1->PlayerCameraManager->StartCameraShake(CameraShake);*/
}
